...
export const actDeletePublicBookmarks = make(PublicBookmarkController.removeMany, { guard: 'admin' })
...
export const actDeleteUserBookmarks = make(UserBookmarkController.removeMany)
